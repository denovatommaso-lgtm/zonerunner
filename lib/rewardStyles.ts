...
type BorderStyle = {
  ...
  overlayGradient?: { colors: string[] };
  animatedSpin?: boolean;
  animatedPulse?: boolean;
};

export const territoryLabelStyles: Record<RewardTier, TextStyle> = {
...
export const avatarBorderStyles: Record<RewardTier, BorderStyle> = {
