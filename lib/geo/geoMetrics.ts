...
export function approximatePolygonAreaKm2(points: GeoCoord[]): number {
...
export function computeElevationGainLossMeters(
  points: AltitudeSample[]
  ...
  for (const p of points) {
    ...
    if (acc != null && acc > MAX_ALT_ACCURACY_M) continue;
