...
const xpProgression_1 = require("./xpProgression");
const palette = [
...
function computeLevel(xp, cfg = xpProgression_1.defaultXPConfig) {
    const state = (0, xpProgression_1.levelFromTotalXp)(xp, cfg);
    return {
        level: state.level,
        xp,
